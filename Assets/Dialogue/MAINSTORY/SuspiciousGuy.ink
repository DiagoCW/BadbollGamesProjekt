...
Hell no! <b>Poisoning</b>, maybe! Period! He knew how to hold his weight, no way he'd die from that shit. He had at least a good 15 years of heavy drinking left in him. #speaker: Leif
...
-> QuestionHub
= LastNight
I was at the bar for most of the night. Peter and Sleepy Guy was there as well. We had a good time! #speaker: Leif
{ talkedToArmchairGuy: 
...
- else:
    ...
    He sits in the armchair close to the bar disk, you can't miss him. He's narcoleptic and tends to fall asleep randomly. Talk to him when you get the chance. #speaker: Leif
    Anyway, <>
}
...
That ain't right. After Peter came back from the shop, he was lowkey ruining the vibe, so me and sleepyhead went home. #speaker: Leif
...
For sure brother, don't worry about it. He's probably at the bar right now, and drifted off into a peaceful sleep. #speaker: Leif
-> QuestionHub
}
