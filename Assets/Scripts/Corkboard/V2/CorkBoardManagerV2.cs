...
public class CorkboardManagerV2 : MonoBehaviour
{
    ...
    private SlotV2[] slots;
    private CorkboardTriggerV2 corkboardTrigger;

    private void Awake()
    {
        slots = Object.FindObjectsByType<SlotV2>(FindObjectsSortMode.None);
        corkboardTrigger = Object.FindAnyObjectByType<CorkboardTriggerV2>();
    ...
    private void Update()
    {
        ...
        if (AllSlotsFilled())
        {
            ...
            {
                DraggableClueV2 clue = slots[i].GetComponentInChildren<DraggableClueV2>();
